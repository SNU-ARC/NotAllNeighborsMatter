...
from spconv.pytorch import spconv_utils
from spconv.pytorch.spconv_utils import (non_max_suppression_cpu,
...
try:
    from spconv.pytorch.spconv_utils import non_max_suppression
except ImportError:
    pass
