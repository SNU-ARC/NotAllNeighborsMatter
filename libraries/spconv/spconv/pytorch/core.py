...
class ImplicitGemmIndiceData(object):
    def __init__(self, out_indices: torch.Tensor, indices: torch.Tensor,
                 ...
                 ksize: List[int], stride: List[int], dilation: List[int], padding: List[int], yj_bit_count_fwd: torch.Tensor, yj_bit_count_bwd: torch.Tensor):
        self.out_indices = out_indices
        self.indices = indices
        ...
        self.dilation = dilation
        self.padding = padding
        self.yj_bit_count_fwd = yj_bit_count_fwd
        self.yj_bit_count_bwd = yj_bit_count_bwd
