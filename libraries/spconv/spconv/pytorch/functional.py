...
yj_bitcount_export_export = None
class SparseImplicitGemmFunction(Function):
    def get_yj_bitcount_export():
        global yj_bitcount_export_export
        return yj_bitcount_export_export
    ...
    def forward(ctx,
        ...
        try:
            ...
            out, mask_out, mask_width = ops.implicit_gemm(features, filters,
                                                        ...
                                                        fp32_accum, is_inverse,
                                                        selected_tune_res, bitcount_export=bitcount_export, yj_bit_count = yj_bit_count, yj_bitcount_export=yj_bc_export_temp,
                                                        prune_edge=prune_edge)
            if bitcount_export:
                global yj_bitcount_export_export
                yj_bitcount_export_export = yj_bc_export_temp
        except Exception as e:
        ...
        if is_train:
            ...
            # ctx.yj_bitcount_bwd = yj_bitcount_bwd
        return out
    ...
    def backward(ctx, grad_output):
        ...
        # yj_bitcout_bwd = ctx.yj_bitcount_bwd
        ...
        try:
            input_bp, filters_bp = ops.implicit_gemm_backward(
                ...
                # yj_bitcount_bwd=yj_bitcout_bwd
                )
        except Exception as e:
