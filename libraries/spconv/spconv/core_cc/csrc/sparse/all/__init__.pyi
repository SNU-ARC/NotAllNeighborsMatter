...
class SpconvOps:
    ...
    def generate_conv_inds_mask_stage1(indices: Tensor, indice_pairs_bwd: Tensor, indice_pairs_uniq: Tensor, indice_num_per_loc: Tensor, batch_size: int, output_dims: List[int], input_dims: List[int], ksize: List[int], stride: List[int], padding: List[int], dilation: List[int], transposed: bool = False, stream_int: int = 0) -> None: 
        ...
        ...
    @staticmethod
    def generate_conv_inds_mask_stage2(indices: Tensor, hashdata: Tensor, indice_pairs_fwd: Tensor, indice_pairs_bwd: Tensor, indice_pairs_uniq: Tensor, out_inds: Tensor, mask_fwd: Tensor, mask_bwd: Tensor, yj_bit_count_fwd: Tensor, yj_bit_count_bwd: Tensor, num_out_act: int, batch_size: int, output_dims: List[int], input_dims: List[int], ksize: List[int], stride: List[int], padding: List[int], dilation: List[int], transposed: bool = False, stream_int: int = 0) -> int: 
        """
        Args:
            indices: 
            hashdata: 
        ...
        ...
    @staticmethod
    def generate_bitcount(pair_mask_clone: Tensor, yj_bit_count: Tensor, stream_int: int =  0) -> None: 
        """
        Args:
            pair_mask_clone: 
            yj_bit_count: 
        ...
        ...
    @staticmethod
    def unset_pair(pair_fwd: Tensor, prune_edge: int, stream_int: int =  0) -> None: 
        """
        Args:
            pair_fwd: 
            prune_edge: 
        ...
        ...
    @staticmethod
    def generate_subm_conv_inds(indices: Tensor, hashdata: Tensor, indice_pairs: Tensor, out_inds: Tensor, indice_num_per_loc: Tensor, batch_size: int, input_dims: List[int], ksize: List[int], dilation: List[int], indice_pair_mask: Tensor =  Tensor(), backward: bool = False, yj_bit_count: Tensor =  Tensor(), stream_int: int =  0) -> int: 
        """
        Args:
            indices: 
            hashdata: 
